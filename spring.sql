...
--
-- Hôte : localhost
-- Généré le : lun. 10 fév. 2025 à 21:05
...
--
-- Structure de la table `partage_note`
--
...
--
-- Déchargement des données de la table `partage_note`
--
...
ALTER TABLE `commentaire`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK7xmsfrgnlagssdl5dpo59n0ya` (`note_id`),
...
--
-- Index pour la table `partage_note`
--
ALTER TABLE `partage_note`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FKcsjr5h34d4vbebe8x6l8t7ocp` (`utilisateur_destinataire_id`),
  ADD KEY `FKeh03i2o2eayy71gcuwshag3ia` (`note_id`),
  ADD KEY `FKbgas34vj1aeus3skd9p14lydo` (`utilisateur_partageur_id`);
...
--
-- AUTO_INCREMENT pour la table `partage_note`
--
ALTER TABLE `partage_note`
...
--
ALTER TABLE `commentaire`
  ADD CONSTRAINT `FK7xmsfrgnlagssdl5dpo59n0ya` FOREIGN KEY (`note_id`) REFERENCES `note` (`id`),
...
--
-- Contraintes pour la table `partage_note`
--
ALTER TABLE `partage_note`
  ADD CONSTRAINT `FKbgas34vj1aeus3skd9p14lydo` FOREIGN KEY (`utilisateur_partageur_id`) REFERENCES `utilisateur` (`id`),
  ADD CONSTRAINT `FKcsjr5h34d4vbebe8x6l8t7ocp` FOREIGN KEY (`utilisateur_destinataire_id`) REFERENCES `utilisateur` (`id`),
  ADD CONSTRAINT `FKeh03i2o2eayy71gcuwshag3ia` FOREIGN KEY (`note_id`) REFERENCES `note` (`id`);
COMMIT;
